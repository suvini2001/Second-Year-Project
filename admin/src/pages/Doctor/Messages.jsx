    ...
    <div className="min-h-[70vh] py-6">
      <div className="flex flex-col gap-3 mb-6">
        ...
        <div className="flex flex-col gap-2 items-center">
          <div className="flex w-full max-w-2xl items-center gap-2 rounded-2xl border border-blue-200 bg-white py-2 px-4 shadow-inner focus-within:ring-2 focus-within:ring-blue-400 transition">
            <FiSearch className="text-blue-600" />
            <input
              type="search"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              placeholder="Search by patient or latest message"
